 ...
 */
package com.yasuenag.ffmasmtools.jvmci.aarch64;
...
import com.yasuenag.ffmasmtools.jvmci.internal.aarch64.AArch64AsmTemplate;


/**
 * Assembly builder for AArch64 to install machine code via JVMCI.
 *
 * @author Yasumasa Suenaga
 */
public class JVMCIAArch64AsmBuilder extends AArch64AsmBuilder<JVMCIAArch64AsmBuilder>{

  private final AArch64AsmTemplate asmTemplate;

  /**
   * Constructor of JVMCIAArch64AsmBuilder.
   * This c'tor creates CodeSegment with DEFAULT_CODE_SEGMENT_SIZE implicitly.
   */
  public JVMCIAArch64AsmBuilder() throws PlatformException, UnsupportedPlatformException{
   ...
   */
  public JVMCIAArch64AsmBuilder(long codeSegmentSize) throws PlatformException, UnsupportedPlatformException{
    var seg = new CodeSegment(codeSegmentSize);
    super(seg, null);
    asmTemplate = new AArch64AsmTemplate(this);
    Cleaner.create().register(this, new CodeSegment.CleanerAction(seg));
  }

  /**
   * MethodHandle cannot be created by JVMCIAMD64AsmBuilder.
   *
   ...
   */
  public JVMCIAArch64AsmBuilder emitPrologue(){
    asmTemplate.emitPrologue();
    return this;
  }

  /**
   * Emit epilogue machine code. It means "LDP", "AUTIAZ" (if needs),  and "RET".
   *
   * @return this instance
   */
  public JVMCIAArch64AsmBuilder emitEpilogue(){
