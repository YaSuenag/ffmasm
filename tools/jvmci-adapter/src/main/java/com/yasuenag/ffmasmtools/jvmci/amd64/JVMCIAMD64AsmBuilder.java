...
/**
 * Assembly builder for AMD64 to install machine code via JVMCI.
 *
 * @author Yasumasa Suenaga
 */
public class JVMCIAMD64AsmBuilder extends AMD64AsmBuilder<JVMCIAMD64AsmBuilder>{

  private final AMD64AsmTemplate asmTemplate;

  /**
   * Constructor of JVMCIAMD64AsmBuilder.
   * This c'tor creates CodeSegment with DEFAULT_CODE_SEGMENT_SIZE implicitly.
   */
  public JVMCIAMD64AsmBuilder() throws PlatformException, UnsupportedPlatformException{
   ...
   */
  public JVMCIAMD64AsmBuilder(long codeSegmentSize) throws PlatformException, UnsupportedPlatformException{
   ...
   */
  public JVMCIAMD64AsmBuilder emitPrologue(){
   ...
   * @return this instance
   */
  public JVMCIAMD64AsmBuilder emitEpilogue(){
