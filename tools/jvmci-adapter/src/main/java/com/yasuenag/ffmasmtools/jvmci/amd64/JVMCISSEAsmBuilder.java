...
/**
 * Assembly builder for SSE instruction set to install machine code via JVMCI.
 *
 * @author Yasumasa Suenaga
 */
public class JVMCISSEAsmBuilder extends SSEAsmBuilder<JVMCISSEAsmBuilder>{

  private final AMD64AsmTemplate asmTemplate;

  /**
   * Constructor of JVMCISSEAsmBuilder.
   * This c'tor creates CodeSegment with DEFAULT_CODE_SEGMENT_SIZE implicitly.
   */
  public JVMCISSEAsmBuilder() throws PlatformException, UnsupportedPlatformException{
   ...
   */
  public JVMCISSEAsmBuilder(long codeSegmentSize) throws PlatformException, UnsupportedPlatformException{
  ...
  /**
   * MethodHandle cannot be created by JVMCISSEAsmBuilder.
   *
   ...
   */
  public JVMCISSEAsmBuilder emitPrologue(){
   ...
   * @return this instance
   */
  public JVMCISSEAsmBuilder emitEpilogue(){
